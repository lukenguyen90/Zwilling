...
<cfscript>
    ...
    public any function getListSupplier(struct rc) {
        // if(!structKeyExists(SESSION, "listSupplier")){
            SESSION.listSupplier = queryToArray(VARIABLES.purchase_orderService.getCompany('',2));
        // }
        variables.fw.renderData("Json", SESSION.listSupplier);                                      
    }
